...
- If you are running v0.8.7.4 as distributed by weisscoin.org you do not need to upgrade.
  The binaries distributed on weisscoin.org contain their own copy of openssl so they are unaffected by this issue.
